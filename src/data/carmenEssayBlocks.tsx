...
const carmenEssayBlocks = [
  {
    type: 'text',
    content: `One of the cheapest bars in Södermalm. No music, no waiters — just chatter. Which, for me, was ideal. I’ve always hated shouting over basslines. My Welsh friend used to say it was the only place in Stockholm that resembled the pubs back home. Small tables, packed close. A little dark. A little intimate.`,
  },
  {
    type: 'image',
  ...
  {
    type: 'text',
    content: `It was just down the street from my tiny bedsit — and for a while, it became a second home. When I was learning photography, I had a homework assignment: portraits of strangers under artificial light. Carmen instantly came to mind. I started bringing my camera often. Took portraits of friends, regulars, drunks, and whoever else sat still long enough.`,
  },
  {
    type: 'image',
  ...
  {
    type: 'text',
    content: `Carmen closed a few months later. It reopened later under new ownership. I haven’t gone back. But the practice I got there — the light, the faces, the stories — stayed with me.`,
  },
  {
    type: 'image',
